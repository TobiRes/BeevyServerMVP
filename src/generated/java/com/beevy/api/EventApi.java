    ...
    default ResponseEntity<List<EventResource>> getEvents() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("[ {  \"summary\" : \"summary\",  \"date\" : \"date\",  \"registeredMembers\" : [ {    \"mail\" : \"mail\",    \"name\" : \"name\",    \"userID\" : \"userID\"  }, {    \"mail\" : \"mail\",    \"name\" : \"name\",    \"userID\" : \"userID\"  } ],  \"address\" : {    \"zip\" : 0,    \"city\" : \"city\",    \"street\" : \"street\"  },  \"currentMemberCount\" : 1,  \"possibleMemberCount\" : 6,  \"endDate\" : \"endDate\",  \"admin\" : {    \"mail\" : \"mail\",    \"name\" : \"name\",    \"userID\" : \"userID\"  },  \"description\" : \"description\",  \"title\" : \"title\",  \"type\" : \"category1\",  \"userID\" : \"userID\",  \"userSecret\" : \"userSecret\"}, {  \"summary\" : \"summary\",  \"date\" : \"date\",  \"registeredMembers\" : [ {    \"mail\" : \"mail\",    \"name\" : \"name\",    \"userID\" : \"userID\"  }, {    \"mail\" : \"mail\",    \"name\" : \"name\",    \"userID\" : \"userID\"  } ],  \"address\" : {    \"zip\" : 0,    \"city\" : \"city\",    \"street\" : \"street\"  },  \"currentMemberCount\" : 1,  \"possibleMemberCount\" : 6,  \"endDate\" : \"endDate\",  \"admin\" : {    \"mail\" : \"mail\",    \"name\" : \"name\",    \"userID\" : \"userID\"  },  \"description\" : \"description\",  \"title\" : \"title\",  \"type\" : \"category1\",  \"userID\" : \"userID\",  \"userSecret\" : \"userSecret\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
