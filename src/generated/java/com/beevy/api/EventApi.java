    ...
    default ResponseEntity<List<EventResource>> getEvents() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("[ {  \"summary\" : \"summary\",  \"date\" : \"date\",  \"registeredMembers\" : [ \"registeredMembers\", \"registeredMembers\" ],  \"eventID\" : \"eventID\",  \"address\" : {    \"zip\" : 0,    \"joinedEvents\" : [ \"joinedEvents\", \"joinedEvents\" ],    \"city\" : \"city\",    \"street\" : \"street\",    \"createdEvents\" : [ \"createdEvents\", \"createdEvents\" ]  },  \"currentMemberCount\" : 1,  \"possibleMemberCount\" : 6,  \"endDate\" : \"endDate\",  \"admin\" : {    \"tempAccessToken\" : \"tempAccessToken\",    \"joinedEvents\" : [ \"joinedEvents\", \"joinedEvents\" ],    \"mail\" : \"mail\",    \"createdEvents\" : [ \"createdEvents\", \"createdEvents\" ],    \"userID\" : \"userID\",    \"username\" : \"username\",    \"token\" : \"token\"  },  \"description\" : \"description\",  \"title\" : \"title\",  \"type\" : \"event\"}, {  \"summary\" : \"summary\",  \"date\" : \"date\",  \"registeredMembers\" : [ \"registeredMembers\", \"registeredMembers\" ],  \"eventID\" : \"eventID\",  \"address\" : {    \"zip\" : 0,    \"joinedEvents\" : [ \"joinedEvents\", \"joinedEvents\" ],    \"city\" : \"city\",    \"street\" : \"street\",    \"createdEvents\" : [ \"createdEvents\", \"createdEvents\" ]  },  \"currentMemberCount\" : 1,  \"possibleMemberCount\" : 6,  \"endDate\" : \"endDate\",  \"admin\" : {    \"tempAccessToken\" : \"tempAccessToken\",    \"joinedEvents\" : [ \"joinedEvents\", \"joinedEvents\" ],    \"mail\" : \"mail\",    \"createdEvents\" : [ \"createdEvents\", \"createdEvents\" ],    \"userID\" : \"userID\",    \"username\" : \"username\",    \"token\" : \"token\"  },  \"description\" : \"description\",  \"title\" : \"title\",  \"type\" : \"event\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
